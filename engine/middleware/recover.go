...
type (
	...
	LogErrorFunc func(c engine.Context, err error, stack []byte) error
...
func Recover() engine.MiddlewareFunc {
	return RecoverWithConfig(DefaultRecoverConfig)
}

// RecoverWithConfig returns a Recover middleware with config.
// See: `Recover()`.
func RecoverWithConfig(config RecoverConfig) engine.MiddlewareFunc {
	// Defaults
